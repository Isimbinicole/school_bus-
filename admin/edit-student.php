...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <!-- <li class="nav-item menu-open ">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item menu-open ">
                                    <a href="manage-students.php" class="nav-link active">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-12">
                            <form action="includes/edit-student.php?id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data" id="add_record">
                                <div class="card card-primary card-outline">
                                    <div class="row ">
                                        <div class="col-md-12" style="font-size: 13px;padding: 20px;">
                                            <p style="font-weight: bold;padding-left: 5px;"> Student edit form <a href="add-student.php" class="btn btn-sm btn-danger" style="float: right;margin-right: 10px;"><i class="fa fa-times"></i></a></p>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" class="form-control" placeholder="Enter student's names" id="student_name" name="student_name" value="<?php echo $student_names; ?>">
                                                                        </div>
                                                                        <!-- /.input group -->
                                                                    </div>
                                                                </div><!-- /.col-md-12 -->
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                                                            ...
                                                                            <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" data-toggle="datetimepicker" placeholder="mm/dd/yyyy" name="bod" value="<?php echo $DOB; ?>" />
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" class="form-control" placeholder="Enter student card number" name="card" id="card" value="<?php echo $card_number; ?>">
                                                                        </div>
                                                                        <!-- /.input group -->
                                                                    </div>
                                                                    <!-- /.form group -->
    ...
    <script type="text/javascript">
        ...
        $("#avatar-2").fileinput({
            ...
            defaultPreviewContent: '<img src="../images/students/<?php echo $profile_image; ?>" alt="Your Avatar" style="width:160px"><h6 class="text-muted">Click to select</h6>',
            layoutTemplates: {
