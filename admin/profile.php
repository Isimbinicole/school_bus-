...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="row ">
                    ...
                    <form action="./includes/edit-profile.php" method="post" enctype="multipart/form-data" id="add_record">
                        <div class="col-md-12">
                            <div class="card card-primary card-outline">
                                <div class="row ">
                                    <div class="col-md-12" style="font-size: 13px;padding: 20px;">
                                        <p style="font-weight: bold;padding: 5px 0px 0px 5px;"> Your profile info </p>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" class="form-control" placeholder="Enter your names" id="driver_name" name="admin_name" value="<?php echo $admin_names; ?>">
                                                                    </div>
                                                                    <!-- /.input group -->
                                                                </div>
                                                            </div><!-- /.col-md-12 -->
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" class="form-control" placeholder="Enter your email " name="email" id="driver_nid" value="<?php echo $email; ?>">
                                                                    </div>
                                                                    <!-- /.input group -->
                                                                </div>
                                                            </div><!-- /.col-md-12 -->
    ...
    <script type="text/javascript">
        ...
        $("#avatar-2").fileinput({
            ...
            defaultPreviewContent: '<img src="../images/admin/<?php echo $profile; ?>" alt="Your Avatar" style="width:160px"><h6 class="text-muted">Click to select</h6>',
            layoutTemplates: {
