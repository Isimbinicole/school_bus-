    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="row ">
            <form action="includes/add-driver.php" method="post" enctype="multipart/form-data" id="add_record">
              <div class="col-md-12">
                <div class="card card-primary card-outline">
                  <div class="row ">
                    <div class="col-md-12" style="font-size: 13px;padding: 20px;">
                      <p style="font-weight: bold;padding: 5px 0px 0px 5px;"> Driver registration form</p>
                                ...
                                <div class="col-md-12">
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" placeholder="Enter drivers's names" id="driver_name" name="driver_name">
                                    </div>
                                    <!-- /.input group -->
                                  </div>
                                </div><!-- /.col-md-12 -->
                                <div class="col-md-12">
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" placeholder="Enter driver's national identintity card " name="driver_nid" id="driver_nid">
                                    </div>
                                    <!-- /.input group -->
                                  </div>
                                </div><!-- /.col-md-12 -->
