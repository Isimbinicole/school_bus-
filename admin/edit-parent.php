...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="row ">
                        <form action="includes/edit-parent.php?id=<?php echo $_GET['p']; ?>" method="post" enctype="multipart/form-data" id="add_record">

                            <?php
                            $sql = "SELECT * FROM parents WHERE status='1' AND parent_ID='" . $_GET['p'] . "'";
                            $exe = $conn->query($sql);
                            while ($row = $exe->fetch_array()) {
                                $fathers_name = $row['fathers_names'];
                                $mothers_name = $row['mothers_names'];
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" class="form-control" placeholder="Enter father's names" id="father_name" name="father_name" value="<?php echo $fathers_name; ?>">
                                                                        </div>
                                                                        <!-- /.input group -->
                                                                    </div>
                                                                </div><!-- /.col-md-12 -->
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" class="form-control" placeholder="Enter father's national identintity card " name="father_nid" id="father_nid" value="<?php echo $fathers_NID; ?>">
                                                                        </div>
                                                                        <!-- /.input group -->
                                                                    </div>
                                                                </div><!-- /.col-md-12 -->
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" class="form-control" placeholder="Enter mother's names" name="mother_name" id="mother_name" value="<?php echo $mothers_name; ?>">
                                                                        </div>
                                                                        <!-- /.input group -->
                                                                    </div>
                                                                </div><!-- /.col-md-12 -->
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" class="form-control" placeholder="Enter mother's national identity card number" name="mother_nid" id="mother_nid" value="<?php echo $mothers_NID; ?>">
                                                                        </div>
                                                                        <!-- /.input group -->
                                                                    </div>
                                                                </div><!-- /.col-md-12 -->
    ...
    <script type="text/javascript">
        ...
        $("#avatar-2").fileinput({
            ...
            defaultPreviewContent: '<img src="../images/parents/<?php echo $fathers_img; ?>" alt="Your Avatar" style="width:160px"><h6 class="text-muted">Click to select</h6>',
            layoutTemplates: {
        ...
        $("#avatar-1").fileinput({
            ...
            msgErrorClass: 'alert  alert-danger',
            defaultPreviewContent: '<img src="../images/parents/<?php echo $mothers_img; ?>" alt="Your Avatar" style="width:160px"><h6 class="text-muted">Click to select</h6>',
            layoutTemplates: {
                main2: '{preview} ' + btnCust + ' {remove} {browse}'
            },
            allowedFileExtensions: ["jpg", "png", "gif"]
