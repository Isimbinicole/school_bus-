...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="container-fluid">
          ...
          ?>
            ...
            <div class="row ">
              ...
              <div class="col-md-12">
                <form action="includes/add-student.php?p=<?php echo $parent_ID; ?>" method="post" enctype="multipart/form-data" id="add_record">
                  <div class="card card-primary card-outline">
                    <div class="row ">
                      <div class="col-md-12" style="font-size: 13px;padding: 20px;">
                        <p style="font-weight: bold;padding-left: 5px;"> Student registration form <a href="add-student.php" class="btn btn-sm btn-danger" style="float: right;margin-right: 10px;"><i class="fa fa-times"></i></a></p>
                              ...
                              <div class="col-md-5">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="kv-avatar center-block" style="width:200px">
                                    <input id="avatar-2" name="student_image" type="file" class="file-loading">
                                  </div>
                                </div>
                              </div> <!-- /.col-md-6 -->
                              <div class="col-md-7">
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      ...
                                      <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter student's names" id="student_name" name="student_name">
                                      </div>
                                      <!-- /.input group -->
                                    </div>
                                  </div><!-- /.col-md-12 -->
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                        ...
                                        <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" data-toggle="datetimepicker" placeholder="mm/dd/yyyy" name="bod" />
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      ...
                                      <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter student card number" name="card" id="card">
                                      </div>
                                      <!-- /.input group -->
                                    </div>
                                    <!-- /.form group -->
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    To add new students, click on the <b>add student</b> on the corresponding parent
                  </div>
                  <div class="card-body">
                    <table id="example1" class="table table-bordered table-sm " style="font-size: 13px;margin-top: 40px;">
                      <thead>
                        <tr>
                          <th>Profile </th>
                          <th>Father's name </th>
  ...
  <script type="text/javascript">
    ...
    $("#avatar-2").fileinput({
      ...
      defaultPreviewContent: '<img src="../images/students/icon.png" alt="Your Avatar" style="width:160px"><h6 class="text-muted">Click to select</h6>',
      layoutTemplates: {
