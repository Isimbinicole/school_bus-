                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="edit-student.php?id=<?php echo $row['student_ID']; ?>" class="btn btn-sm text-info" style="float: right;margin-right: 5px;"> <i class="fas fa-pencil-alt mr-1"></i></a>
                          </td>
                          <td>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="#" class="btn btn-sm text-danger recycle-d" data-toggle="modal" data-target="#modal-default" id="<?php echo $row['student_ID']; ?>" style="float: right; margin-right: 15px; font-size: 1.2rem;"> <i class="fas  fa-recycle"></i></a>
                          </td>
