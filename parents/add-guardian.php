          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open ">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item ">
                  <a href="add-guardian.php" class="nav-link active">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="row  justify-content-center">
            <form action="includes/add-guardian.php" method="post" enctype="multipart/form-data" id="add_record">
              <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" placeholder="Enter guardians's names" id="guardian_name" name="guardian_name">
                                    </div>
                                    <!-- /.input group -->
                                  </div>
                                </div><!-- /.col-md-12 -->
